    ...
    <div class="container">
      <div class="row">
        <div class="col-md-9" data-aos="fade-up">
          <h3 class="category-title">Search Result For: {{ $query }}</h3>
          ...
          <div class="d-md-flex post-entry-2 half">
            ...
            <div>
              ...
              <div class="d-flex align-items-center author">
                <div class="photo">
                  @if($berita->user->foto)
                    <img src="{{ asset('storage/' . $berita->user->foto) }}" alt="" class="img-fluid img-thumbnail">
                  @else
                    <img src="{{ asset('user/img/person-2.jpg') }}" alt="" class="img-fluid img-thumbnail">
                  @endif
                </div>
                <div class="name">
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-latest" role="tabpanel" aria-labelledby="pills-latest-tab">
                ...
                <div class="post-entry-1 border-bottom">
                  ...
                  <h2 class="mb-2">
                    <a href="{{ route('user.berita.baca', $brt->slug) }}">{{ $brt->title }}</a>
                  </h2>
            ...
            <ul class="aside-links list-unstyled">
              ...
              <li>
                <a href="{{ route('user.berita.kategori', $kategori->slug) }}">
                  ...
                  <span class="text-capitalize">{{ $kategori->nama }}</span>
                </a>
              </li>
              @endforeach
            </ul>
