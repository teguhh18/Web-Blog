                        ...
                        <form action="{{ route('user.profile.update', encrypt($user->id)) }}" method="post"
                            ...
                            <div class="avatar justify-center my-4">
                                <div class="w-48 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                                    @if ($user->foto)
                                        <img id="image-preview" src="{{ route('storage.show', ['path' => $user->foto]) }}"
                                            alt="{{ $user->name }}" />
                                    @else
                                        <img id="image-preview" src="https://placehold.co/200x200?text=No+Image"
                                            alt="No Image" />
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="text" name="name" id="name" placeholder="Your Name"
                                    value="{{ old('name', $user->name) }}" class="input input-bordered w-full" />
                                @error('name')
                                    <label class="label">
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="email" name="email" id="email" placeholder="Your Email"
                                    value="{{ old('email', $user->email) }}" class="input input-bordered w-full" />
                                @error('email')
                                    <label class="label">
                                        <span class="label-text-alt text-error">{{ $message }}</span>
                                    </label>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="file" name="foto" id="foto"
                                    class="file-input file-input-bordered w-full" onchange="previewImage()" />
                                @error('foto')
                                    <label class="label">
                                        <span class="label-text-alt text-error">{{ $message }}</span>
                                    </label>
                        ...
                        <form action="{{ route('user.password.update', encrypt($user->id)) }}" method="post"
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="password" name="newpassword" id="newpassword"
                                    placeholder="Masukkan password baru" class="input input-bordered w-full" required />
                                @error('newpassword')
                                    <label class="label">
                                        <span class="label-text-alt text-error">{{ $message }}</span>
                                    </label>
                            ...
                            <div class="form-control w-full">
                                ...
                                <input type="password" name="renewpassword" id="renewpassword"
                                    placeholder="Masukkan lagi password baru" class="input input-bordered w-full"
                                    required />
                                @error('renewpassword')
                                    <label class="label">
                                        <span class="label-text-alt text-error">{{ $message }}</span>
