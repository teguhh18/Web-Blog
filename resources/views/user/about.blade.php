        ...
        <div class="row mb-5">
          ...
          <div class="d-md-flex post-entry-2 half">
            <a href="#" class="me-4 thumbnail">
              <img src="{{  asset('user/img/post-landscape-2.jpg') }}" alt="" class="img-fluid">
            </a>
          ...
          <div class="d-md-flex post-entry-2 half mt-5">
            <a href="#" class="me-4 thumbnail order-2">
              <img src="{{  asset('user/img/post-landscape-1.jpg') }}" alt="" class="img-fluid">
            </a>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-between align-items-lg-center">
          <div class="col-lg-5 mb-4 mb-lg-0">
            <h2 class="display-4 mb-4">Berita Terbaru</h2>
            ...
            <p><a href="{{ route('user.berita') }}" class="more">Lihat Semua Berita</a></p>
          </div>
          <div class="col-lg-6">
            <div class="row">
              <div class="col-6">
                <img src="{{  asset('user/img/post-portrait-3.jpg') }}" alt="" class="img-fluid mb-4">
              </div>
              <div class="col-6 mt-4">
                <img src="{{  asset('user/img/post-portrait-4.jpg') }}" alt="" class="img-fluid mb-4">
              </div>
            </div>
          </div>
        </div>
