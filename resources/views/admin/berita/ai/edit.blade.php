            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.berita.update', $berita) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input value="{{ $topik }}" type="text" name="title" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="post" class="col-sm-2 col-form-label">Isi post</label>
                        <div class="col-sm-10">
                            <input value="{{ $post }}" id="post" type="hidden" name="post" required>
                            <trix-editor input="post" name="post"></trix-editor>
                        </div>
                    </div>
                    {{-- <div class="row mb-3"> --}}
