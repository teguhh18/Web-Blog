            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Blog Pustik</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="{{ route('otp.check') }}"  method="post">
                    @csrf
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="token" name="token" class="form-control" id="token" required>
                        <div class="invalid-feedback">Masukkan OTP yang kami kirim via Email</div>
                      </div>
                    </div>
                    <div class="col-12">
